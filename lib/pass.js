    ...
    dropZone = new Dropzone("div#message", {
		...
		success : function(file, data){
            ...
            if(typeof data.error!="undefined"){
                ...
                $( "#popUp" ).html('File sent').popup( "open");
...
function events(){
    ...
    $( document ).on( "tap", '#header .button.refresh', function( e ) {refresh();});
	$( document ).on( "tap", '#clear', function( e ) {$('#message').html("");});
    $( document ).on( "tap", '#save', function( e ) {setSaveMessage($(this))});
	$( document ).on( "tap", '.history .button.send', function( e ) {sendHistory($(this));});
    $( document ).on( "tap", '.history .button.delete', function( e ) {deleteMessage($(this));});
    ...
    $( document ).on( "tap", '#logout', function( e ) {localStorage.clear;location.reload();});
}